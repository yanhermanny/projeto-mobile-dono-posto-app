        ...
        List<Funcionario> funcionarios = new List<Funcionario>()
            {
                ...
                new Funcionario { Nome = "Maria", NomePosto = "POSTO 2", EnderecoPosto = "RUA Design", DtRequisicao = "Requisitado dia 13/05/2023 ás 16:45"},
                new Funcionario { Nome = "Pedro", NomePosto = "POSTO 3", EnderecoPosto = "RUA Gestão", DtRequisicao = "Requisitado dia 13/05/2023 ás 16:45" },
                new Funcionario { Nome = "Pedro", NomePosto = "POSTO 4", EnderecoPosto = "RUA Gestão",DtRequisicao = "Requisitado dia 13/05/2023 ás 16:45"},
                new Funcionario { Nome = "Pedro", NomePosto = "POSTO 5", EnderecoPosto = "RUA Gestão", DtRequisicao = "Requisitado dia 13/05/2023 ás 16:45" },
                new Funcionario { Nome = "Pedro", NomePosto = "POSTO 6", EnderecoPosto = "RUA Gestão", DtRequisicao = "Requisitado dia 13/05/2023 ás 16:45" }
            };
